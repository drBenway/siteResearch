...
class CSVExport extends ExportAbstract
{
    ...
    /**
     * test if creation of filename has succeeded
     */
    private function testIfFileExists()
    {
    }
...
// The w+ parameter will wipe out and overwrite any existing file with the same name
        $handle = fopen("Output/" . $this->filename, 'w+') or die("can't open file");
